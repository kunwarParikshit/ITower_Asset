...
public final class Configuration {
    ...
    @Nullable
    public Uri getUserLogoutUri() {
        return mUserLogoutUri;
    }
    ...
    private void readConfiguration() throws InvalidConfigurationException {
        ...
        if(mContext.getApplicationContext().getPackageName().equalsIgnoreCase("infozech.tawal")){
            configSource =
                    Okio.buffer( Okio.source(mResources.openRawResource(R.raw.auth_config_midc)));
        }else{
            configSource =
                    Okio.buffer( Okio.source(mResources.openRawResource(R.raw.auth_config_ad_mast)));
        }
        // BufferedSource configSource =
        ...
        mConfigHash = "/2jmj7l5rSw0yVb/vlWAYkK/YBwk=";
        ...
        if (getConfigString("discovery_uri") == null) {
            ...
            mUserLogoutUri = getRequiredConfigWebUri("logout_uri");
