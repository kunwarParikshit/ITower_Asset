 ...
 * update by dhakan Lal on 25-May-2024
 * 1.0
 */
...
//        SimpleDateFormat sdf = new SimpleDateFormat(myFormat, Locale.US);
    ...
    private class CheckListDetailsTask extends AsyncTask<Void, Void, Void> {
        ...
        private CheckListDetailsTask(Context con,Intent i,String txnId,String sId,
                                     String scDate,String dgType,String activityId) {
            this.con = con;
            this.txnId = txnId;
            this.scDate = scDate;
            this.activityId = activityId;
