 ...
 */
public class FragRejectedSparePart extends Fragment {
    ...
    public class GetPendingSpareTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("appType","3")); //(1--PENDING,2-APPROVED,3-REJECTED )
