...
public class FragAssigmentDetails extends Fragment {
    View view;
    ...
    void SetRemarks() {
        if (responce_list != null && responce_list.getAssign()!=null && responce_list.getAssign().size() > 0) {
            lv.setVisibility(View.VISIBLE);
            txt_no_remarks_added.setVisibility(View.GONE);
            lv.setFastScrollEnabled(true);
            lv.setAdapter(new AdapterAssignHis(getActivity(),responce_list,0));
        } else {
