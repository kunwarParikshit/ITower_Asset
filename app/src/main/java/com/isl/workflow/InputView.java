...
public class InputView {
    ...
    public InputView(HashMap<String, String> prvValues){
        com.isl.taskform.EditTextControl.prvValues = prvValues;
    }
    ...
    public EditText addDate(final Context context,final FormControl formControl){
        ...
        editText.setBackgroundResource( R.drawable.icon_calender);
    ...
    public EditText addGroup(final Context context,FormControl formControl){
        final EditText editText = addEditText(context,formControl);
        editText.setBackgroundResource( R.drawable.chk_list);
        editText.setFocusableInTouchMode( false );
        editText.setText(formControl.getTv().getText().toString());
        editText.setPadding(120,0,0,0);
        editText.setTextColor( Color.parseColor( "#2B4E81" ) );
